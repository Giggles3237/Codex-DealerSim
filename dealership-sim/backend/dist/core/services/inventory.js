...
exports.estimateDaysSupply = exports.acquirePack = exports.createVehicle = exports.applyPricingPolicy = exports.calculateDesirability = exports.ageInventory = void 0;
...
const ageInventory = (inventory, economyDemand) => {
    return inventory.map((vehicle) => {
        ...
        return {
            ...
            desirability: (0, math_1.clamp)(vehicle.desirability - bucket.rate * 100 * (1.1 - desirabilityFactor), 10, 100),
        };
    });
};
exports.ageInventory = ageInventory;
const calculateDesirability = (vehicle, economySeason, demandIndex) => {
    const base = 60;
    ...
    return (0, math_1.clamp)(base + segmentDemand * 15 + seasonBonus + conditionBonus + demandIndex * 10, 20, 100);
};
exports.calculateDesirability = calculateDesirability;
const applyPricingPolicy = (baseAsking, policy, desirability, ageDays, agingDiscounts) => {
    let multiplier = shared_1.PRICING_POLICY_MULTIPLIERS[policy];
...
exports.applyPricingPolicy = applyPricingPolicy;
const createVehicle = (overrides, rng, coefficients, baseCost, pricingState) => {
    ...
    const desirability = overrides.desirability ?? (0, math_1.clamp)(55 + rng.nextFloat() * 30, 30, 100);
    ...
    if (pricingState) {
        ...
        asking = Math.round((0, exports.applyPricingPolicy)(baseAsking, policy, desirability, ageDays, pricingState.agingDiscounts) / 100) * 100;
    }
...
const acquirePack = (type, qty, rng, coefficients, pricingState, avgCostPerUnit) => {
    const vehicles = [];
    let totalCost = 0;
    ...
    for (let i = 0; i < qty; i += 1) {
        ...
        const vehicle = (0, exports.createVehicle)({
...
exports.acquirePack = acquirePack;
const estimateDaysSupply = (inventory, trailingSales) => {
    if (trailingSales === 0) {
        return inventory.length * 10;
    }
    return (inventory.length / trailingSales) * 30;
};
exports.estimateDaysSupply = estimateDaysSupply;
